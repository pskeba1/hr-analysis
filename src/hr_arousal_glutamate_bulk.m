...
T1 = [T1 table(max(table2array(T1(:,2:16)),[],2),'VariableNames',{'maxChange'})];
...
T2 = [T2 table(max(table2array(T2(:,2:16)),[],2),'VariableNames',{'maxChange'})];
T3 = assemble_table(output_points_arous_w_lm, output_names_arous_w_lm, arousals_w_llm3,...
    arousals_wo_llm3, num_arousals3, num_lm3);
T3 = [T3 table(max(table2array(T3(:,2:16)),[],2),'VariableNames',{'maxChange'})];
...
T4 = [T4 table(max(table2array(T4(:,2:16)),[],2),'VariableNames',{'maxChange'})];
